...
const Intro = () => {
  return (
    <div className='Intro'>
      ...
      <span className='desc'><p> Hi, Am a Junior Software Engineer with a deeper passion in writing codes to assist and solve others problems. Skilled in Javascript, ReactJs, Node, PostgreSQL, MongoDB,
